  ...
  useEffect(() => {
    ...
    const fetchApplications = async () => {
      try {
        ...
        setError('ไม่สามารถโหลดข้อมูลประวัติการสมัครงานได้');
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA] font-sans pb-12">
      ...
      <div className="bg-[#020263] pt-16 pb-20 relative overflow-hidden">
        {/* Abstract shapes matching Engenius theme */}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10 text-center">
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-4 tracking-tight">
            ประวัติการสมัครงานและนัดสัมภาษณ์
          </h1>
          <p className="text-[#A5CBE5] text-lg max-w-2xl mx-auto">
            ติดตามสถานะและตรวจสอบงานที่คุณได้ทำการสมัครไว้ทั้งหมดในที่เดียว
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 -mt-10 relative z-20">
        {/* Stats Row */}
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 shrink-0 flex items-center justify-around mb-8">
          <div className="text-center px-4">
            <div className="text-3xl font-black text-[#020263]">{applications.length}</div>
          ...
          <div className="text-center px-4">
            <div className="text-3xl font-black text-[#00003D]">
              {
          ...
          <div className="w-px h-12 bg-gray-100" />
          <div className="text-center px-4">
            <div className="text-3xl font-black text-[#E00016]">
          ...
          {applications.length === 0 && !error ? (
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
              ...
              <p className="text-gray-500 mb-8 max-w-sm mx-auto">
                ค้นหางานที่ใช่และเริ่มต้นสมัครงานเพื่อสานฝันอาชีพของคุณ
              </p>
              <Link
                href="/jobs"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-y-2 gap-x-4 text-xs font-medium text-gray-500 mt-4">
                        <div className="flex items-center gap-1.5 bg-[#F5F7FA] px-2.5 py-1.5 rounded-lg">
                          ...
                          <span>
                            {app.job.locationDistrict || app.job.locationProvince ? (
                              ...
                              app.job.companyAddress || 'ไม่ระบุสถานที่'
                            )}
                          </span>
                        </div>
                        <div className="flex items-center gap-1.5 bg-[#F5F7FA] px-2.5 py-1.5 rounded-lg">
                        ...
                        <div className="flex items-center gap-1.5 mt-2 sm:mt-0 sm:ml-auto text-gray-400">
                          ...
                          <span>สมัครเมื่อ {formatDate(app.appliedAt)}</span>
                        </div>
                      </div>
                      ...
                      {(app.status === 'INTERVIEW' || app.interviewDate) && (
                        <div className="mt-4 pt-4 border-t border-gray-100/60">
                          <div className="flex items-center gap-2 bg-[#F5F7FA] w-fit px-3 py-2 rounded-lg text-sm font-medium">
                            ...
                            <span className="text-gray-500">นัดสัมภาษณ์:</span>
                            <span className="text-[#020263] font-bold">
                              {app.interviewDate ? formatDateTime(app.interviewDate) : 'ยังไม่ระบุวัน'}
                            </span>
                          </div>
                        </div>
                      )}
