...
const getInitialGroups = (t: any): JobGroup[] => [
  ...
  },
  {
    ...
    items: [
      { id: 'bangkok', name: t("groups.regional.items.bangkok"), count: 0, href: '/all_group_job/bangkok', icon: <BangkokIcon /> },
      { id: 'central', name: t("groups.regional.items.central"), count: 0, href: '/all_group_job/central', icon: <CentralIcon /> },
      { id: 'west', name: t("groups.regional.items.west"), count: 0, href: '/all_group_job/west', icon: <WestIcon /> },
      { id: 'east', name: t("groups.regional.items.east"), count: 0, href: '/all_group_job/east', icon: <EastIcon /> },
      { id: 'northeast', name: t("groups.regional.items.northeast"), count: 0, href: '/all_group_job/northeast', icon: <NortheastIcon /> },
      { id: 'north', name: t("groups.regional.items.north"), count: 0, href: '/all_group_job/north', icon: <NorthIcon /> },
      { id: 'south', name: t("groups.regional.items.south"), count: 0, href: '/all_group_job/south', icon: <SouthIcon /> },
    ],
  },
];
...
export default function AllGroupJobPage() {
  ...
  const totalActiveJobsLabel = useMemo(() => {
    return stats.totalJobs > 0 ? formatJobCount(stats.totalJobs) : t('Allthai');
  }, [stats.totalJobs, t]);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white font-sans selection:bg-blue-100">
      ...
      <main className="flex-1">
        <div className="relative overflow-hidden bg-linear-to-r from-[#020263] via-[#0a0a7a] to-[#1a1a8a]">
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-10 left-10 w-32 h-32 bg-white rounded-full blur-3xl" />
            <div className="absolute top-20 right-20 w-48 h-48 bg-white rounded-full blur-3xl" />
          </div>
          <div className="absolute bottom-0 left-0 right-0 h-1.5 bg-linear-to-r from-[#E71F29] via-[#3B82F6] to-[#059669]" />

          <div className="relative container mx-auto px-4 max-w-7xl py-14 sm:py-20 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6 sm:gap-10 mt-10">
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-extrabold text-white">{stats.groupCount}</div>
                <div className="text-blue-300 text-xs sm:text-sm font-medium mt-0.5">{t('stats.main_groups')}</div>
              </div>
              <div className="w-px h-10 bg-white/20 self-center hidden sm:block" />
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-extrabold text-white">{stats.categoryCount}</div>
                <div className="text-blue-300 text-xs sm:text-sm font-medium mt-0.5">{t('stats.sub_categories')}</div>
              </div>
              <div className="w-px h-10 bg-white/20 self-center hidden sm:block" />
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-extrabold text-white">{totalActiveJobsLabel}</div>
                <div className="text-blue-300 text-xs sm:text-sm font-medium mt-0.5">
                  {stats.totalJobs > 0 ? t('stats.total_jobs') : t('stats.all_areas')}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl py-10 sm:py-14">
          ...
          <div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/jobs" className="group inline-flex items-center justify-center gap-2.5 px-8 py-3.5 rounded-xl bg-[#020263] text-white font-bold hover:bg-[#0a0a7a] hover:shadow-lg hover:shadow-[#020263]/20 transition-all hover:-translate-y-0.5">
